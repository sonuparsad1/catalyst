...
const quickActions = [
  { label: "Publish new event", to: "/admin/events" },
  { label: "Start attendance scan", to: "/admin/scan" },
  { label: "Invite VIP members", to: "/admin/members" },
  { label: "Issue refund batch", disabled: true },
];

const disabledClass =
  "rounded-2xl border border-border bg-background/40 px-4 py-3 text-left text-textSecondary opacity-60 cursor-not-allowed";
      ...
      <header className="flex flex-col gap-4 border-b border-border pb-6 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            type="button"
            disabled
            title="Export tooling will be available soon."
          ...
          <button
            type="button"
            disabled
            title="Publishing updates is coming soon."
            ...
            {quickActions.map((action) =>
              action.disabled ? (
                <button
                  ...
                  type="button"
                  disabled
                  title="This automation is not enabled yet."
