  ...
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-col gap-10 px-6 py-12">
      <header className="space-y-3">
        <p className="text-sm uppercase tracking-[0.4em] text-cyan-300">About Us</p>
      ...
      <section className="rounded-3xl border border-slate-800 bg-gradient-to-r from-slate-900 via-slate-950 to-slate-900 p-8">
        <h3 className="text-xl font-semibold text-white">What we value</h3>
        <ul className="mt-4 grid gap-4 text-sm text-slate-300 sm:grid-cols-2">
